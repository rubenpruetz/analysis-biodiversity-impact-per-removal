...
path_ag = Path('/Users/rpruetz/Documents/work/primary/analyses/cdr_biodiversity/unfccc_annex')
...
fig_path = Path('/Users/rpruetz/Documents/work/primary/analyses/cdr_biodiversity/analysis_biodiversity_impact_per_removal/paper_plots/ncc_figs')
...
fig.supylabel(f"Share of remaining refugia conserved & allocated due to CDR\n[%] ('net' effect = avoided warming - land allocation)",
...
for model in models:
    ...
    for ssp in ssps:
        ...
        try:
            ...
            bounds_ar = [1, 5, 10, 20]
            norm_ar = mpl.colors.BoundaryNorm(bounds_ar, mpl.cm.BuPu.N, extend='max')
            cmap_ar = cmr.get_sub_cmap('BuPu', 0.2, 1)  # specify colormap subrange
